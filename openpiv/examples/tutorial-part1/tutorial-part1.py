...
frame_a  = tools.imread( resource_filename('openpiv','examples/test1/exp1_001_a.bmp' ))
frame_b  = tools.imread( resource_filename('openpiv','examples/test1/exp1_001_b.bmp' ))
...
u1, v1, sig2noise = pyprocess.extended_search_area_piv( 
        frame_a.astype(np.int32), frame_b.astype(np.int32), 
        window_size=24, overlap=12, dt=0.02, search_area_size=24, 
        sig2noise_method='peak2peak' )
