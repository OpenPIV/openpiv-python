/* Generated by Cython 0.14.1 on Thu Apr 28 10:42:44 2011 */
...
#endif
#include <math.h>
#define __PYX_HAVE_API__openpiv__src__lib
#include "stdio.h"
#include "stdlib.h"
...
typedef __pyx_t_5numpy_float64_t __pyx_t_7openpiv_3src_3lib_DTYPEf_t;

typedef __pyx_t_5numpy_int64_t __pyx_t_7openpiv_3src_3lib_DTYPEi_t;
...
/* Module declarations from openpiv.src.lib */

static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_7openpiv_3src_3lib_DTYPEf_t = { "DTYPEf_t", NULL, sizeof(__pyx_t_7openpiv_3src_3lib_DTYPEf_t), 'R' };
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_7openpiv_3src_3lib_DTYPEi_t = { "DTYPEi_t", NULL, sizeof(__pyx_t_7openpiv_3src_3lib_DTYPEi_t), 'I' };
#define __Pyx_MODULE_NAME "openpiv.src.lib"
static int __pyx_module_is_main_openpiv__src__lib = 0;

/* Implementation of openpiv.src.lib */
...
static char __pyx_k_13[] = "A cython module for common operations requiring speed.";
static char __pyx_k_14[] = "openpiv.src.lib";
...
static char __pyx_k__replace_nans[] = "replace_nans";
...
static PyObject *__pyx_n_s__replace_nans;
...
static PyObject *__pyx_pf_7openpiv_3src_3lib_replace_nans(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_7openpiv_3src_3lib_replace_nans[] = "Replace nans in an array using an iterative image inpainting algorithm.\n    \n    The algorithm is the following:\n    \n    1) For each element in the input array replace it by a weighted average\n       of the neighbouring elements which are not nan. The weights depends\n       of the method type. If ``method=localmean`` weight are equal to 1/( (2*kernel_size+1)**2 -1 )\n       \n    2) Several iterations are needed if there are adjacent nan elements.\n       If this is the case, inforation is \"spread\" from the edges of the missing\n       regions iteratively, until the variation is below a certain threshold. \n    \n    Parameters\n    ----------\n    \n    array : 2d np.ndarray\n        an array containing  nan that have to be replaced\n        \n    n_iter : int\n        the number of iterations\n    \n    kernel_size : int\n        the size of the kernel, default is 1\n        \n    method : str\n        the method used to replace nans. Valid options are\n        `localmean`.\n        \n    Returns\n    -------\n    \n    filled : 2d np.ndarray\n        a copy of the input array, where nans have been replaced\n        \n    ";
static PyMethodDef __pyx_mdef_7openpiv_3src_3lib_replace_nans = {__Pyx_NAMESTR("replace_nans"), (PyCFunction)__pyx_pf_7openpiv_3src_3lib_replace_nans, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(__pyx_doc_7openpiv_3src_3lib_replace_nans)};
static PyObject *__pyx_pf_7openpiv_3src_3lib_replace_nans(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  PyArrayObject *__pyx_v_inans;
  PyArrayObject *__pyx_v_jnans;
  ...
  Py_buffer __pyx_bstruct_jnans;
  Py_ssize_t __pyx_bstride_0_jnans = 0;
  Py_ssize_t __pyx_bshape_0_jnans = 0;
  Py_buffer __pyx_bstruct_inans;
  Py_ssize_t __pyx_bstride_0_inans = 0;
  Py_ssize_t __pyx_bshape_0_inans = 0;
  ...
  int __pyx_t_44;
  int __pyx_t_45;
  __pyx_t_7openpiv_3src_3lib_DTYPEf_t __pyx_t_46;
  int __pyx_t_47;
  int __pyx_t_48;
  int __pyx_t_49;
  int __pyx_t_50;
  static PyObject **__pyx_pyargnames[] = {&__pyx_n_s__array,&__pyx_n_s__n_iter,&__pyx_n_s__kernel_size,&__pyx_n_s__method,0};
  __Pyx_RefNannySetupContext("replace_nans");
  __pyx_self = __pyx_self;
  if (unlikely(__pyx_kwds)) {
    Py_ssize_t kw_args = PyDict_Size(__pyx_kwds);
    PyObject* values[4] = {0,0,0,0};
    values[3] = ((PyObject*)__pyx_n_s__localmean);
    ...
    switch (PyTuple_GET_SIZE(__pyx_args)) {
      ...
      case  1:
      values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__n_iter);
      if (likely(values[1])) kw_args--;
      else {
        __Pyx_RaiseArgtupleInvalid("replace_nans", 0, 2, 4, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
      case  2:
      if (kw_args > 0) {
    ...
    if (unlikely(kw_args > 0)) {
      if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, PyTuple_GET_SIZE(__pyx_args), "replace_nans") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    }
    __pyx_v_array = ((PyArrayObject *)values[0]);
    __pyx_v_n_iter = __Pyx_PyInt_AsInt(values[1]); if (unlikely((__pyx_v_n_iter == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    if (values[2]) {
      __pyx_v_kernel_size = __Pyx_PyInt_AsInt(values[2]); if (unlikely((__pyx_v_kernel_size == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
    ...
    switch (PyTuple_GET_SIZE(__pyx_args)) {
      case  4:
      __pyx_v_method = ((PyObject*)PyTuple_GET_ITEM(__pyx_args, 3));
      case  3:
      __pyx_v_kernel_size = __Pyx_PyInt_AsInt(PyTuple_GET_ITEM(__pyx_args, 2)); if (unlikely((__pyx_v_kernel_size == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      case  2:
      __pyx_v_n_iter = __Pyx_PyInt_AsInt(PyTuple_GET_ITEM(__pyx_args, 1)); if (unlikely((__pyx_v_n_iter == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  ...
  __Pyx_RaiseArgtupleInvalid("replace_nans", 0, 2, 4, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("openpiv.src.lib.replace_nans");
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_v_inans = ((PyArrayObject *)Py_None); __Pyx_INCREF(Py_None);
  __pyx_v_jnans = ((PyArrayObject *)Py_None); __Pyx_INCREF(Py_None);
  __pyx_bstruct_filled.buf = NULL;
  __pyx_bstruct_kernel.buf = NULL;
  __pyx_bstruct_inans.buf = NULL;
  __pyx_bstruct_jnans.buf = NULL;
  ...
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_method), (&PyString_Type), 1, "method", 1))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_array, (PyObject*)__pyx_v_array, &__Pyx_TypeInfo_nn___pyx_t_7openpiv_3src_3lib_DTYPEf_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
 ...
 */
  ...
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = PyEval_CallObjectWithKeywords(__pyx_t_2, ((PyObject *)__pyx_t_3), ((PyObject *)__pyx_t_4)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 55; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_filled, (PyObject*)__pyx_t_5, &__Pyx_TypeInfo_nn___pyx_t_7openpiv_3src_3lib_DTYPEf_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 2, 0, __pyx_stack) == -1)) {
 ...
 */
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_kernel, (PyObject*)__pyx_t_6, &__Pyx_TypeInfo_nn___pyx_t_7openpiv_3src_3lib_DTYPEf_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 2, 0, __pyx_stack) == -1)) {
 ...
 */
  ...
  __pyx_t_1 = __Pyx_GetName(__pyx_m, __pyx_n_s__np); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 62; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = PyObject_GetAttr(__pyx_t_1, __pyx_n_s__isnan); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 62; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  ...
  if (PyTuple_CheckExact(__pyx_t_4) && likely(PyTuple_GET_SIZE(__pyx_t_4) == 2)) {
    ...
    {
      __Pyx_BufFmt_StackElem __pyx_stack[1];
      __Pyx_SafeReleaseBuffer(&__pyx_bstruct_inans);
      __pyx_t_8 = __Pyx_GetBufferAndValidate(&__pyx_bstruct_inans, (PyObject*)__pyx_t_7, &__Pyx_TypeInfo_nn___pyx_t_7openpiv_3src_3lib_DTYPEi_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack);
      if (unlikely(__pyx_t_8 < 0)) {
        PyErr_Fetch(&__pyx_t_9, &__pyx_t_10, &__pyx_t_11);
        if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_inans, (PyObject*)__pyx_v_inans, &__Pyx_TypeInfo_nn___pyx_t_7openpiv_3src_3lib_DTYPEi_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {
      ...
      __pyx_bstride_0_inans = __pyx_bstruct_inans.strides[0];
      __pyx_bshape_0_inans = __pyx_bstruct_inans.shape[0];
      if (unlikely(__pyx_t_8 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 62; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
    __pyx_t_7 = 0;
    __Pyx_DECREF(((PyObject *)__pyx_v_inans));
    __pyx_v_inans = ((PyArrayObject *)__pyx_t_1);
    __pyx_t_1 = 0;
    __pyx_t_12 = ((PyArrayObject *)__pyx_t_2);
    {
      __Pyx_BufFmt_StackElem __pyx_stack[1];
      __Pyx_SafeReleaseBuffer(&__pyx_bstruct_jnans);
      __pyx_t_8 = __Pyx_GetBufferAndValidate(&__pyx_bstruct_jnans, (PyObject*)__pyx_t_12, &__Pyx_TypeInfo_nn___pyx_t_7openpiv_3src_3lib_DTYPEi_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack);
      if (unlikely(__pyx_t_8 < 0)) {
        PyErr_Fetch(&__pyx_t_11, &__pyx_t_10, &__pyx_t_9);
        if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_jnans, (PyObject*)__pyx_v_jnans, &__Pyx_TypeInfo_nn___pyx_t_7openpiv_3src_3lib_DTYPEi_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {
      ...
      __pyx_bstride_0_jnans = __pyx_bstruct_jnans.strides[0];
      __pyx_bshape_0_jnans = __pyx_bstruct_jnans.shape[0];
      if (unlikely(__pyx_t_8 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 62; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
    __pyx_t_12 = 0;
    __Pyx_DECREF(((PyObject *)__pyx_v_jnans));
    __pyx_v_jnans = ((PyArrayObject *)__pyx_t_2);
    __pyx_t_2 = 0;
  } else {
    __pyx_t_3 = PyObject_GetIter(__pyx_t_4); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 62; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __pyx_t_1 = __Pyx_UnpackItem(__pyx_t_3, 0); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 62; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_1);
    if (!(likely(((__pyx_t_1) == Py_None) || likely(__Pyx_TypeTest(__pyx_t_1, __pyx_ptype_5numpy_ndarray))))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 62; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __pyx_t_2 = __Pyx_UnpackItem(__pyx_t_3, 1); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 62; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
    if (!(likely(((__pyx_t_2) == Py_None) || likely(__Pyx_TypeTest(__pyx_t_2, __pyx_ptype_5numpy_ndarray))))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 62; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    if (__Pyx_EndUnpack(__pyx_t_3, 2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 62; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_t_7 = ((PyArrayObject *)__pyx_t_1);
    {
      __Pyx_BufFmt_StackElem __pyx_stack[1];
 ...
 */
  __pyx_t_4 = PyObject_RichCompare(((PyObject *)__pyx_v_method), ((PyObject *)__pyx_n_s__localmean), Py_EQ); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 65; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_13 = __Pyx_PyObject_IsTrue(__pyx_t_4); if (unlikely(__pyx_t_13 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 65; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  if (__pyx_t_13) {

    /* "openpiv/src/lib.pyx":66
 *     # depending on kernel type, fill kernel array
 *     if method == 'localmean':
 *         for i in range(2*kernel_size+1):             # <<<<<<<<<<<<<<
 *             for j in range(2*kernel_size+1):
 *                 kernel[i,j] = 1.0
 */
    __pyx_t_14 = ((2 * __pyx_v_kernel_size) + 1);
    for (__pyx_t_8 = 0; __pyx_t_8 < __pyx_t_14; __pyx_t_8+=1) {
      __pyx_v_i = __pyx_t_8;

      /* "openpiv/src/lib.pyx":67
 *     if method == 'localmean':
 *         for i in range(2*kernel_size+1):
 *             for j in range(2*kernel_size+1):             # <<<<<<<<<<<<<<
 *                 kernel[i,j] = 1.0
 ...
 */
        ...
        __pyx_t_19 = -1;
        if (__pyx_t_17 < 0) {
          __pyx_t_17 += __pyx_bshape_0_kernel;
          if (unlikely(__pyx_t_17 < 0)) __pyx_t_19 = 0;
        } else if (unlikely(__pyx_t_17 >= __pyx_bshape_0_kernel)) __pyx_t_19 = 0;
        if (__pyx_t_18 < 0) {
          __pyx_t_18 += __pyx_bshape_1_kernel;
          if (unlikely(__pyx_t_18 < 0)) __pyx_t_19 = 1;
        } else if (unlikely(__pyx_t_18 >= __pyx_bshape_1_kernel)) __pyx_t_19 = 1;
        ...
        *__Pyx_BufPtrStrided2d(__pyx_t_7openpiv_3src_3lib_DTYPEf_t *, __pyx_bstruct_kernel.buf, __pyx_t_17, __pyx_bstride_0_kernel, __pyx_t_18, __pyx_bstride_1_kernel) = 1.0;
      }
    }
    goto __pyx_L6;
  }
 ...
 */
  __pyx_t_20 = (__pyx_v_array->dimensions[0]);
  for (__pyx_t_8 = 0; __pyx_t_8 < __pyx_t_20; __pyx_t_8+=1) {
    __pyx_v_i = __pyx_t_8;

    /* "openpiv/src/lib.pyx":72
 *     # fill new array with input elements
 *     for i in range(array.shape[0]):
 *         for j in range(array.shape[1]):             # <<<<<<<<<<<<<<
 *             filled[i,j] = array[i,j]
 * 
 */
    __pyx_t_21 = (__pyx_v_array->dimensions[1]);
    for (__pyx_t_16 = 0; __pyx_t_16 < __pyx_t_21; __pyx_t_16+=1) {
      __pyx_v_j = __pyx_t_16;

      /* "openpiv/src/lib.pyx":73
 *     for i in range(array.shape[0]):
 *         for j in range(array.shape[1]):
 *             filled[i,j] = array[i,j]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      __pyx_t_23 = -1;
      if (__pyx_t_19 < 0) {
        __pyx_t_19 += __pyx_bshape_0_array;
        if (unlikely(__pyx_t_19 < 0)) __pyx_t_23 = 0;
      } else if (unlikely(__pyx_t_19 >= __pyx_bshape_0_array)) __pyx_t_23 = 0;
      if (__pyx_t_22 < 0) {
        __pyx_t_22 += __pyx_bshape_1_array;
        if (unlikely(__pyx_t_22 < 0)) __pyx_t_23 = 1;
      } else if (unlikely(__pyx_t_22 >= __pyx_bshape_1_array)) __pyx_t_23 = 1;
      ...
      __pyx_t_25 = -1;
      if (__pyx_t_23 < 0) {
        __pyx_t_23 += __pyx_bshape_0_filled;
        if (unlikely(__pyx_t_23 < 0)) __pyx_t_25 = 0;
      } else if (unlikely(__pyx_t_23 >= __pyx_bshape_0_filled)) __pyx_t_25 = 0;
      if (__pyx_t_24 < 0) {
        __pyx_t_24 += __pyx_bshape_1_filled;
        if (unlikely(__pyx_t_24 < 0)) __pyx_t_25 = 1;
      } else if (unlikely(__pyx_t_24 >= __pyx_bshape_1_filled)) __pyx_t_25 = 1;
      if (unlikely(__pyx_t_25 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_25);
        {__pyx_filename = __pyx_f[0]; __pyx_lineno = 73; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      }
      *__Pyx_BufPtrStrided2d(__pyx_t_7openpiv_3src_3lib_DTYPEf_t *, __pyx_bstruct_filled.buf, __pyx_t_23, __pyx_bstride_0_filled, __pyx_t_24, __pyx_bstride_1_filled) = (*__Pyx_BufPtrStrided2d(__pyx_t_7openpiv_3src_3lib_DTYPEf_t *, __pyx_bstruct_array.buf, __pyx_t_19, __pyx_bstride_0_array, __pyx_t_22, __pyx_bstride_1_array));
    }
  }

  /* "openpiv/src/lib.pyx":76
 * 
 *     # make several passes
 ...
 *             j = jnans[k]
 */
    __pyx_t_26 = PyObject_Length(((PyObject *)__pyx_v_inans)); if (unlikely(__pyx_t_26 == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 79; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    for (__pyx_t_25 = 0; __pyx_t_25 < __pyx_t_26; __pyx_t_25+=1) {
      __pyx_v_k = __pyx_t_25;

      /* "openpiv/src/lib.pyx":80
 *         # for each nan element
 *         for k in range(len(inans)):
 *             i = inans[k]             # <<<<<<<<<<<<<<
 *             j = jnans[k]
 ...
 */
      ...
      __pyx_t_28 = -1;
      if (__pyx_t_27 < 0) {
        __pyx_t_27 += __pyx_bshape_0_inans;
        if (unlikely(__pyx_t_27 < 0)) __pyx_t_28 = 0;
      } else if (unlikely(__pyx_t_27 >= __pyx_bshape_0_inans)) __pyx_t_28 = 0;
      ...
      __pyx_v_i = (*__Pyx_BufPtrStrided1d(__pyx_t_7openpiv_3src_3lib_DTYPEi_t *, __pyx_bstruct_inans.buf, __pyx_t_27, __pyx_bstride_0_inans));

      /* "openpiv/src/lib.pyx":81
 *         for k in range(len(inans)):
 *             i = inans[k]
 *             j = jnans[k]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      __pyx_t_29 = -1;
      if (__pyx_t_28 < 0) {
        __pyx_t_28 += __pyx_bshape_0_jnans;
        if (unlikely(__pyx_t_28 < 0)) __pyx_t_29 = 0;
      } else if (unlikely(__pyx_t_28 >= __pyx_bshape_0_jnans)) __pyx_t_29 = 0;
      ...
      __pyx_v_j = (*__Pyx_BufPtrStrided1d(__pyx_t_7openpiv_3src_3lib_DTYPEi_t *, __pyx_bstruct_jnans.buf, __pyx_t_28, __pyx_bstride_0_jnans));

      /* "openpiv/src/lib.pyx":84
 * 
 *             # initialize to zero
 *             filled[i,j] = 0.0             # <<<<<<<<<<<<<<
 *             n = 0
 ...
 */
      ...
      __pyx_t_31 = -1;
      if (__pyx_t_29 < 0) {
        __pyx_t_29 += __pyx_bshape_0_filled;
        if (unlikely(__pyx_t_29 < 0)) __pyx_t_31 = 0;
      } else if (unlikely(__pyx_t_29 >= __pyx_bshape_0_filled)) __pyx_t_31 = 0;
      if (__pyx_t_30 < 0) {
        __pyx_t_30 += __pyx_bshape_1_filled;
        if (unlikely(__pyx_t_30 < 0)) __pyx_t_31 = 1;
      } else if (unlikely(__pyx_t_30 >= __pyx_bshape_1_filled)) __pyx_t_31 = 1;
      if (unlikely(__pyx_t_31 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_31);
        {__pyx_filename = __pyx_f[0]; __pyx_lineno = 84; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      }
      *__Pyx_BufPtrStrided2d(__pyx_t_7openpiv_3src_3lib_DTYPEf_t *, __pyx_bstruct_filled.buf, __pyx_t_29, __pyx_bstride_0_filled, __pyx_t_30, __pyx_bstride_1_filled) = 0.0;

      /* "openpiv/src/lib.pyx":85
 *             # initialize to zero
 *             filled[i,j] = 0.0
 *             n = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
        __pyx_t_15 = ((2 * __pyx_v_kernel_size) + 1);
        for (__pyx_t_32 = 0; __pyx_t_32 < __pyx_t_15; __pyx_t_32+=1) {
          __pyx_v_J = __pyx_t_32;

          /* "openpiv/src/lib.pyx":92
 * 
 *                     # if we are not out of the boundaries
 ...
 * 
 */
          __pyx_t_13 = (((__pyx_v_i + __pyx_v_I) - __pyx_v_kernel_size) < (__pyx_v_array->dimensions[0]));
          if (__pyx_t_13) {
            __pyx_t_33 = (((__pyx_v_i + __pyx_v_I) - __pyx_v_kernel_size) >= 0);
 ...
 */
            __pyx_t_34 = (((__pyx_v_j + __pyx_v_J) - __pyx_v_kernel_size) < (__pyx_v_array->dimensions[1]));
            if (__pyx_t_34) {
              __pyx_t_13 = (((__pyx_v_j + __pyx_v_J) - __pyx_v_kernel_size) >= 0);
 ...
 */
              ...
              __Pyx_GOTREF(__pyx_t_4);
              __pyx_t_2 = PyObject_GetAttr(__pyx_t_4, __pyx_n_s__isnan); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 96; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
              __Pyx_GOTREF(__pyx_t_2);
              __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
              __pyx_t_35 = ((__pyx_v_i + __pyx_v_I) - __pyx_v_kernel_size);
              __pyx_t_36 = ((__pyx_v_j + __pyx_v_J) - __pyx_v_kernel_size);
              __pyx_t_37 = -1;
              if (__pyx_t_35 < 0) {
                __pyx_t_35 += __pyx_bshape_0_filled;
                if (unlikely(__pyx_t_35 < 0)) __pyx_t_37 = 0;
              } else if (unlikely(__pyx_t_35 >= __pyx_bshape_0_filled)) __pyx_t_37 = 0;
              if (__pyx_t_36 < 0) {
                __pyx_t_36 += __pyx_bshape_1_filled;
                if (unlikely(__pyx_t_36 < 0)) __pyx_t_37 = 1;
              } else if (unlikely(__pyx_t_36 >= __pyx_bshape_1_filled)) __pyx_t_37 = 1;
              ...
              __pyx_t_4 = PyFloat_FromDouble((*__Pyx_BufPtrStrided2d(__pyx_t_7openpiv_3src_3lib_DTYPEf_t *, __pyx_bstruct_filled.buf, __pyx_t_35, __pyx_bstride_0_filled, __pyx_t_36, __pyx_bstride_1_filled))); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 96; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
              __Pyx_GOTREF(__pyx_t_4);
              ...
              __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
              __Pyx_DECREF(((PyObject *)__pyx_t_1)); __pyx_t_1 = 0;
              __pyx_t_33 = __Pyx_PyObject_IsTrue(__pyx_t_4); if (unlikely(__pyx_t_33 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 96; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
              __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
              __pyx_t_34 = (!__pyx_t_33);
              if (__pyx_t_34) {

                /* "openpiv/src/lib.pyx":99
 * 
 *                                 # do not sum itself
 ...
 */
                __pyx_t_34 = ((__pyx_v_I - __pyx_v_kernel_size) != 0);
                if (__pyx_t_34) {
                  __pyx_t_33 = ((__pyx_v_J - __pyx_v_kernel_size) != 0);
 ...
 */
                  ...
                  __pyx_t_39 = -1;
                  if (__pyx_t_37 < 0) {
                    __pyx_t_37 += __pyx_bshape_0_filled;
                    if (unlikely(__pyx_t_37 < 0)) __pyx_t_39 = 0;
                  } else if (unlikely(__pyx_t_37 >= __pyx_bshape_0_filled)) __pyx_t_39 = 0;
                  if (__pyx_t_38 < 0) {
                    __pyx_t_38 += __pyx_bshape_1_filled;
                    if (unlikely(__pyx_t_38 < 0)) __pyx_t_39 = 1;
                  } else if (unlikely(__pyx_t_38 >= __pyx_bshape_1_filled)) __pyx_t_39 = 1;
                  ...
                  __pyx_t_41 = -1;
                  if (__pyx_t_39 < 0) {
                    __pyx_t_39 += __pyx_bshape_0_filled;
                    if (unlikely(__pyx_t_39 < 0)) __pyx_t_41 = 0;
                  } else if (unlikely(__pyx_t_39 >= __pyx_bshape_0_filled)) __pyx_t_41 = 0;
                  if (__pyx_t_40 < 0) {
                    __pyx_t_40 += __pyx_bshape_1_filled;
                    if (unlikely(__pyx_t_40 < 0)) __pyx_t_41 = 1;
                  } else if (unlikely(__pyx_t_40 >= __pyx_bshape_1_filled)) __pyx_t_41 = 1;
                  ...
                  __pyx_t_43 = -1;
                  if (__pyx_t_41 < 0) {
                    __pyx_t_41 += __pyx_bshape_0_kernel;
                    if (unlikely(__pyx_t_41 < 0)) __pyx_t_43 = 0;
                  } else if (unlikely(__pyx_t_41 >= __pyx_bshape_0_kernel)) __pyx_t_43 = 0;
                  if (__pyx_t_42 < 0) {
                    __pyx_t_42 += __pyx_bshape_1_kernel;
                    if (unlikely(__pyx_t_42 < 0)) __pyx_t_43 = 1;
                  } else if (unlikely(__pyx_t_42 >= __pyx_bshape_1_kernel)) __pyx_t_43 = 1;
                  ...
                  __pyx_t_45 = -1;
                  if (__pyx_t_43 < 0) {
                    __pyx_t_43 += __pyx_bshape_0_filled;
                    if (unlikely(__pyx_t_43 < 0)) __pyx_t_45 = 0;
                  } else if (unlikely(__pyx_t_43 >= __pyx_bshape_0_filled)) __pyx_t_45 = 0;
                  if (__pyx_t_44 < 0) {
                    __pyx_t_44 += __pyx_bshape_1_filled;
                    if (unlikely(__pyx_t_44 < 0)) __pyx_t_45 = 1;
                  } else if (unlikely(__pyx_t_44 >= __pyx_bshape_1_filled)) __pyx_t_45 = 1;
                  if (unlikely(__pyx_t_45 != -1)) {
                    __Pyx_RaiseBufferIndexError(__pyx_t_45);
                    {__pyx_filename = __pyx_f[0]; __pyx_lineno = 102; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
                  }
                  *__Pyx_BufPtrStrided2d(__pyx_t_7openpiv_3src_3lib_DTYPEf_t *, __pyx_bstruct_filled.buf, __pyx_t_43, __pyx_bstride_0_filled, __pyx_t_44, __pyx_bstride_1_filled) = ((*__Pyx_BufPtrStrided2d(__pyx_t_7openpiv_3src_3lib_DTYPEf_t *, __pyx_bstruct_filled.buf, __pyx_t_37, __pyx_bstride_0_filled, __pyx_t_38, __pyx_bstride_1_filled)) + ((*__Pyx_BufPtrStrided2d(__pyx_t_7openpiv_3src_3lib_DTYPEf_t *, __pyx_bstruct_filled.buf, __pyx_t_39, __pyx_bstride_0_filled, __pyx_t_40, __pyx_bstride_1_filled)) * (*__Pyx_BufPtrStrided2d(__pyx_t_7openpiv_3src_3lib_DTYPEf_t *, __pyx_bstruct_kernel.buf, __pyx_t_41, __pyx_bstride_0_kernel, __pyx_t_42, __pyx_bstride_1_kernel))));

                  /* "openpiv/src/lib.pyx":103
 *                                     # convolve kernel with original array
 *                                     filled[i,j] = filled[i,j] + filled[i+I-kernel_size, j+J-kernel_size]*kernel[I, J]
 *                                     n = n + 1             # <<<<<<<<<<<<<<
 * 
 ...
 *             else:
 */
      __pyx_t_13 = (__pyx_v_n != 0);
      if (__pyx_t_13) {

        /* "openpiv/src/lib.pyx":107
 *             # divide value by effective number of added elements
 *             if n != 0:
 *                 filled[i,j] = filled[i,j] / n             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
        ...
        __pyx_t_45 = -1;
        if (__pyx_t_31 < 0) {
          __pyx_t_31 += __pyx_bshape_0_filled;
          if (unlikely(__pyx_t_31 < 0)) __pyx_t_45 = 0;
        } else if (unlikely(__pyx_t_31 >= __pyx_bshape_0_filled)) __pyx_t_45 = 0;
        if (__pyx_t_32 < 0) {
          __pyx_t_32 += __pyx_bshape_1_filled;
          if (unlikely(__pyx_t_32 < 0)) __pyx_t_45 = 1;
        } else if (unlikely(__pyx_t_32 >= __pyx_bshape_1_filled)) __pyx_t_45 = 1;
        if (unlikely(__pyx_t_45 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_45);
          {__pyx_filename = __pyx_f[0]; __pyx_lineno = 107; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        }
        __pyx_t_46 = (*__Pyx_BufPtrStrided2d(__pyx_t_7openpiv_3src_3lib_DTYPEf_t *, __pyx_bstruct_filled.buf, __pyx_t_31, __pyx_bstride_0_filled, __pyx_t_32, __pyx_bstride_1_filled));
        ...
        __pyx_t_48 = -1;
        if (__pyx_t_45 < 0) {
          __pyx_t_45 += __pyx_bshape_0_filled;
          if (unlikely(__pyx_t_45 < 0)) __pyx_t_48 = 0;
        } else if (unlikely(__pyx_t_45 >= __pyx_bshape_0_filled)) __pyx_t_48 = 0;
        if (__pyx_t_47 < 0) {
          __pyx_t_47 += __pyx_bshape_1_filled;
          if (unlikely(__pyx_t_47 < 0)) __pyx_t_48 = 1;
        } else if (unlikely(__pyx_t_47 >= __pyx_bshape_1_filled)) __pyx_t_48 = 1;
        if (unlikely(__pyx_t_48 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_48);
          {__pyx_filename = __pyx_f[0]; __pyx_lineno = 107; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        }
        *__Pyx_BufPtrStrided2d(__pyx_t_7openpiv_3src_3lib_DTYPEf_t *, __pyx_bstruct_filled.buf, __pyx_t_45, __pyx_bstride_0_filled, __pyx_t_47, __pyx_bstride_1_filled) = (__pyx_t_46 / __pyx_v_n);
        goto __pyx_L27;
      }
      /*else*/ {

        /* "openpiv/src/lib.pyx":109
 *                 filled[i,j] = filled[i,j] / n
 *             else:
 *                 filled[i,j] = np.nan             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        __Pyx_GOTREF(__pyx_t_4);
        __pyx_t_1 = PyObject_GetAttr(__pyx_t_4, __pyx_n_s__nan); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 109; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_1);
        __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
        __pyx_t_46 = __pyx_PyFloat_AsDouble(__pyx_t_1); if (unlikely((__pyx_t_46 == (npy_float64)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 109; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
        __pyx_t_48 = __pyx_v_i;
        __pyx_t_49 = __pyx_v_j;
        __pyx_t_50 = -1;
        if (__pyx_t_48 < 0) {
          __pyx_t_48 += __pyx_bshape_0_filled;
          if (unlikely(__pyx_t_48 < 0)) __pyx_t_50 = 0;
        } else if (unlikely(__pyx_t_48 >= __pyx_bshape_0_filled)) __pyx_t_50 = 0;
        if (__pyx_t_49 < 0) {
          __pyx_t_49 += __pyx_bshape_1_filled;
          if (unlikely(__pyx_t_49 < 0)) __pyx_t_50 = 1;
        } else if (unlikely(__pyx_t_49 >= __pyx_bshape_1_filled)) __pyx_t_50 = 1;
        ...
        *__Pyx_BufPtrStrided2d(__pyx_t_7openpiv_3src_3lib_DTYPEf_t *, __pyx_bstruct_filled.buf, __pyx_t_48, __pyx_bstride_0_filled, __pyx_t_49, __pyx_bstride_1_filled) = __pyx_t_46;
      }
      __pyx_L27:;
    }
  }

  /* "openpiv/src/lib.pyx":111
 *                 filled[i,j] = np.nan
 * 
 *     return filled             # <<<<<<<<<<<<<<
 */
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s__replace_nans, __pyx_k__replace_nans, sizeof(__pyx_k__replace_nans), 0, 0, 1, 1},
...
#endif
{
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("lib"), __pyx_methods, __Pyx_DOCSTR(__pyx_k_13), 0, PYTHON_API_VERSION);
  #else
  ...
  if (__pyx_module_is_main_openpiv__src__lib) {
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_1 = PyObject_GetAttr(__pyx_t_2, __pyx_n_s__int64); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  if (PyObject_SetAttr(__pyx_m, __pyx_n_s__DTYPEi, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 * 
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_7openpiv_3src_3lib_replace_nans, NULL, __pyx_n_s_14); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  if (PyObject_SetAttr(__pyx_m, __pyx_n_s__replace_nans, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "openpiv/src/lib.pyx":1
 * """A cython module for common operations requiring speed."""             # <<<<<<<<<<<<<<
 * 
 * import numpy as np
 */
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_2);
  if (__pyx_m) {
    __Pyx_AddTraceback("init openpiv.src.lib");
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init openpiv.src.lib");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
